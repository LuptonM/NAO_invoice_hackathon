...
def within_search_area(left, top ,  search_left_start, search_top_start, search_left_range, search_top_range, row1, row2, row_part1, row_part2):
   ...
   if (within_coord_tolerance(left, top ,  search_left_start, search_top_start, search_left_range, search_top_range) and row1 == row2) or is_next_row_part(row1, row2, row_part1, row_part2) or is_row_item_below(row1, row2, row_part1, row_part2):
      return True
   else:
      False
